...
- `bankapp.omdeshmukh304-create.com` → `<NLB hostname from Gateway>`
...
2. Click **New App** → fill in:
   - **Name:** `bankapp`
   - **Project:** `default`
   - **Repo URL:** `https://github.com/omdeshmukh304-create/AI-BankApp-DevOps.git`
...
2. **GitHub Actions** (`.github/workflows/gitops-ci.yml`):
   ...
   - Builds Docker image
   - Pushes `omdeshmukh304-create/ai-bankapp-eks:<sha>` to DockerHub
